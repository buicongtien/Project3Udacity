...
def main(msg: func.ServiceBusMessage):
    ...
    connection = psycopg2.connect(host="postgresql-server-project3.postgres.database.azure.com",user="tienbc@postgresql-server-project3",dbname="patient", password="abcde12345-")
